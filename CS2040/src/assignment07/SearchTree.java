...
public class SearchTree<E>
{
    ...
    {
        // Students will complete this method (required).
        // (Use a private recursive helper function to do all the work.)
    ...
    /* Removed - Students may write this method, or something else if they choose. */
