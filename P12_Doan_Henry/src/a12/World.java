...
//		System.out.println("row " + row + " col " + col);
	...
	private void initializePopulation() {
		...
		// Create Herbivores
		for (int numHerb = 0; numHerb < 100; numHerb++) {
		...
		// Create Carnivore
		for (int numCarn = 0; numCarn < 40; numCarn++) {
...
//				System.out.println("Eating " + i);
	...
	/***
	 * Return the number of Carnivore
	 * @return
	 */
	...
	public void simulateAll() {
		...
		if (day%50 == 0)
			...
			labelH = new JLabel("Herbs: " + numHerbivores());
			labelH.setVerticalTextPosition(JLabel.EAST);
			labelP = new JLabel("Plants: " + numPlants());
			labelP.setVerticalTextPosition(JLabel.BOTTOM);
			labelC = new JLabel("Carns: " + numCarnivores());
			labelC.setVerticalTextPosition(JLabel.BOTTOM);
