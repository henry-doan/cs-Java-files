                                                  ...
                                                  Runnable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6046025583615877813L;
    ...
    public ShapeMover ()
    {
    	...
    	shapes = new Shape[]
        	    {
        	       new Rect    (130,  40,  60, 30, Color.RED),
                   new Rect    (230,  40,  20, 20, Color.BLUE),
                   new Rect    (330,  40,  80, 140, Color.MAGENTA),
                   new Rect    (130, 140, 100, 180, new Color (0.8f, 0.6f, 0.2f)),
        	       new Rect    ( 30, 140,  70, 40, Color.YELLOW),
        	       
        	       new Circle    (130,  300,  60, Color.CYAN),
	               new Circle    (230,  300,  20, Color.WHITE),
	               new Circle    (330,  300,  80, Color.GREEN),
	               new Circle    (130, 400, 100, new Color (0.1f, 0.3f, 0.1f)),
	      	       new Circle    ( 30, 400,  40, Color.ORANGE)
        	    };
