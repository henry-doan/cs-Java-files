...
public class BigFractionTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("Big Fraction " + l + " contains: " + l);
		System.out.println("Big Fraction " + a + " contains: " + a);
		System.out.println("Big Fraction " + f + " contains: " + f);
		System.out.println("Big Fraction " + g + " contains: " + g);
		System.out.println("Big Fraction " + h + " contains: " + h + "\n");
		...
		System.out.println("This is the double for the " + f + " Big fraction: " + f.toDouble());
		System.out.println("This is the double for the " + b.toString() + " Big fraction: " + b.toDouble() + "\n");
	}
